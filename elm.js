...
Elm.CounterList.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var modify = F3(function (id,
   counterAction,
   model) {
      return function () {
         var updateCounter = function (_v0) {
            return function () {
               switch (_v0.ctor)
               {case "_Tuple2":
                  return _U.eq(_v0._0,
      ...
      return _U.replace([["counters"
                         ...
                         function (_v4) {
                            return function () {
                               switch (_v4.ctor)
                               {case "_Tuple2":
                                  return !_U.eq(_v4._0,id);}
                               _U.badCase($moduleName,
                               "on line 40, column 49 to 64");
                            }();
                         },
                         model.counters)]],
      model);
   ...
   var update = function (action) {
      return function () {
         ...
         {case "Insert": return insert;
            case "Modify": return A2(modify,
              action._0,
              action._1);
            case "Remove":
            return remove(action._0);}
         _U.badCase($moduleName,
   ...
   var countersList = F2(function (address,
   model) {
      return A2($List.map,
      viewCounter(address),
      model.counters);
   ...
   var insertButton = function (address) {
...
Elm.CounterListMain = Elm.CounterListMain || {};
Elm.CounterListMain.make = function (_elm) {
   "use strict";
   _elm.CounterListMain = _elm.CounterListMain || {};
   if (_elm.CounterListMain.values)
   return _elm.CounterListMain.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "CounterListMain",
   $Basics = Elm.Basics.make(_elm),
   ...
   _elm.CounterListMain.values = {_op: _op
                                 ,main: main};
   return _elm.CounterListMain.values;
};
Elm.CounterMain = Elm.CounterMain || {};
Elm.CounterMain.make = function (_elm) {
   "use strict";
   _elm.CounterMain = _elm.CounterMain || {};
   if (_elm.CounterMain.values)
   return _elm.CounterMain.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "CounterMain",
   $Basics = Elm.Basics.make(_elm),
   $Counter = Elm.Counter.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var main = $StartApp$Simple.start({_: {}
                                     ...
                                     ,view: $Counter.view});
   _elm.CounterMain.values = {_op: _op
                             ,main: main};
   return _elm.CounterMain.values;
};
Elm.Debug = Elm.Debug || {};
...
Elm.TextMain = Elm.TextMain || {};
Elm.TextMain.make = function (_elm) {
   "use strict";
   _elm.TextMain = _elm.TextMain || {};
   if (_elm.TextMain.values)
   return _elm.TextMain.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
